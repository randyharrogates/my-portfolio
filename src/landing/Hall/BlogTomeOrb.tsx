 ...
 *  Clicking it navigates to /blog (the terminal-style Blog page).
 *
 *  Shares the radiating-glow language with `ProjectsTerminalOrb.tsx` /
 *  `EnterHouseOrb.tsx`: camera-facing billboard planes with a true
 *  `uv`-based radial gradient (a soft circular aura) plus an expanding
 *  sonar ring. Sphere shells can't carry a gradient — every fragment
 *  sits at one radius — so the glow is built on billboard planes. */
