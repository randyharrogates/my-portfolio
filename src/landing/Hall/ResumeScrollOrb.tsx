...
const SCROLL_ORB_COLOR = "#b08ce8"; // resume accent (violet)

/** Violet orb hovering above the resume landmark's floating Akademiya
 *  scroll. Clicking navigates to /resume (the terminal-style Resume page).
 *
