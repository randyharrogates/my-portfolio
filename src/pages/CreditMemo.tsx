...
import LockedDiagram from "../components/LockedDiagram.tsx";
      ...
      <div className="cm-layout">
        ...
        <div className="cm-right">
          ...
          <LockedDiagram
            ...
            requestEmail="randychan_92@outlook.com"
            requestSubject="Credit memo diagram access"
          />
